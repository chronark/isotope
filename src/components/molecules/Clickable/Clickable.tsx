...
const colors = (type: Type): string => {
  ...
  const options: Record<Type, string> = {
    primary:
      "bg-gradient-to-tr from-black to-gray-800 text-gray-50 hover:from-gray-100 hover:to-white hover:text-black border border-0 border-gray-200 hover:border-1",
